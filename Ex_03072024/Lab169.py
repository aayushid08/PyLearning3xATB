...
# import os
# print(os.getcwd())  # ye isliye

file = open("C:/Users/intel/PycharmProjects/PyLearning3xATB/Ex_03072024/TestData.txt", 'r')
content = file.read()
print(content)
file.close()

# ye to andar ke andar ki baat hui, server se lena hai to diffrent mechenism hai